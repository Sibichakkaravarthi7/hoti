...
function BrandForm({ register, watch, errors, setValue, locationMeta, setLocationText }: { register: any; watch: any; errors: any; setValue: any, locationMeta: any, setLocationText: any }) {
    ...
    return <>
        <AppFormFieldWrapper label="Brand Name *" htmlFor={''}>
